...
- **Pricing Plans Split Page Routes (`/pricing-plans` & `/pricing-plans/create`)**:
  1. **Pricing Plans List Page Route** ([`/admin/website-builder/pricing-plans/page.tsx`](file:///d:/Jamal/Event_Management_Admin_Frontend/src/app/admin/website-builder/pricing-plans/page.tsx)): Pricing plans management table with search bar, audience target badges (`Individuals` / `Companies`), monthly pricing, popular badge highlights, status switches, and edit/delete action buttons.
  2. **Add / Edit Pricing Plan Form Page Route** ([`/admin/website-builder/pricing-plans/create/page.tsx`](file:///d:/Jamal/Event_Management_Admin_Frontend/src/app/admin/website-builder/pricing-plans/create/page.tsx)): 5 section cards (Basic Info, Pricing & Currency, Badge & Highlights, Features List, Status & Display Options) + Right-Column Live Pricing Card Preview with Desktop/Mobile switcher.
